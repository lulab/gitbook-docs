...
* **Multianalyte**  (see more in [MultiOmics - cfDNA & evProtein](data-mining/cfDNA-EVP.md))
...
* **cfRNA/exRNA** **- Transcriptome** (see more in [exRNA-seq](tech.-dev./exrna-seq-tech.md))
...
* **Proteome** (see more in [MultiOmics - cfDNA & evProtein](data-mining/cfDNA-EVP.md))
